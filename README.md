...
- 2022-07-12 直近200日の10日間移動合計を直近200日7日間移動合計に変更しました
...
### [直近90日] 検査数の時系列 (日別の検査数と検査数の7日間移動平均)

![直近90日 日別の検査数と移動平均](./images/7days_rollingave_with_tests_30days.png)

### [直近100日] 陽性率の時系列 (感染者数の7日間移動平均と検査数の7日間移動平均から算出)

- 検査データの最終更新日(2022-08-16)
